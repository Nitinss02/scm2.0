package com.scm.scm20.serviceimpl;
...
public class serviceImpl implements userServices {
    ...
    public user saveUser(user user) {
        ...
        user.setRole(List.of(appConstant.ROLE_USER));
    ...
    public Optional<user> updateUser(user user) {
        ...
        user save = saveUser(user2);
        return Optional.ofNullable(save);
    }

    @Override
    public void deleteuser(String id) {
        user user2 = userRepo.findById(id).orElseThrow(() -> new ResourceIsNotFound("User Is Not Found"));
